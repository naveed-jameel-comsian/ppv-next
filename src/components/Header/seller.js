...
export default function SellerHeader({ data = null, isSearch = false, query, setQuery }) {
                    ...
                    <nav className="navbar-nav m-auto d-lg-inline-block d-none">
                        <ul className="main-menu d-flex">
                            ...
                            >
                                <Link
                                    href={"/seller"}
                                    className={`menu-link ${checkActiveMenu("seller")}`}
                                >
                                    <svg
                            ...
                            >
                                <Link
                                    href={"/codes"}
                                    className={`menu-link ${checkActiveMenu("codes")}`}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="18"
                            ...
                            >
                                <Link
                                    href={"/seller-billing"}
                                    className={`menu-link ${checkActiveMenu("seller-billing")}`}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="18"
